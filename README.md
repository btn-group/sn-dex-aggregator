...
secretcli tx compute instantiate $CODE_ID "$INIT" --from a --label "DEX aggregator | btn.group" -y --keyring-backend test --gas 3000000 --gas-prices=3.0uscrt

# Query config
secretcli query compute query secret1y45vkh0n6kplaeqw6ratuertapxupz532vxnn3 '{"config": {}}'

# Register tokens
secretcli tx compute execute secret1y45vkh0n6kplaeqw6ratuertapxupz532vxnn3 '{"register_tokens":{"tokens": [{"address": "secret18vd8fpwxzck93qlwghaj6arh4p7c5n8978vsyg", "contract_hash": "4CD7F64B9ADE65200E595216265932A0C7689C4804BE7B4A5F8CEBED250BF7EA"}, {"address": "secret1vc5zfwt08hu9cctdgkqk6j9y05w6ty0xa8g26s", "contract_hash": "35F5DB2BC5CD56815D10C7A567D6827BECCB8EAF45BC3FA016930C4A8209EA69"}]}}' --from a -y --keyring-backend test --gas 3000000 --gas-prices=3.0uscrt
...
secretcli tx compute execute secret1y45vkh0n6kplaeqw6ratuertapxupz532vxnn3 '{"receive":{"from": "secret1pl2r32z9n3e47950s6ej7mg7pfh7mxd003guum", "amount": "500", "msg": ""}}' --from a -y --keyring-backend test --gas 3000000 --amount "500uscrt" --gas-prices=3.0uscrt

# Query balance of BUTT
secretcli query compute query secret1vc5zfwt08hu9cctdgkqk6j9y05w6ty0xa8g26s '{"exchange_rate": {}}'
...
# Swap BUTT for SCRT
secretcli tx compute execute secret18vd8fpwxzck93qlwghaj6arh4p7c5n8978vsyg '{"send": { "recipient": "secret1y45vkh0n6kplaeqw6ratuertapxupz532vxnn3", "amount": "1", "msg": "" }}' --from a -y --keyring-backend test --gas 9000000 --gas-prices=3.0uscrt
```
